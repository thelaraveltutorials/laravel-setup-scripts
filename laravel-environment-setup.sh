...
if [ "$my_mysql_password" == "$my_mysql_password2" ]; then
    ...
    if [ "$debugMode" == "no" ]; then
        ...
        sudo apt-get install -y  php-pear php-fpm php-dev php-zip php-curl php-xmlrpc php-gd php-mysql php-mbstring php-token-stream php-xml php-json php7.2-common php7.2-bcmath libapache2-mod-php >> TheLaravelTutorial.log
